...
"136":["Phase 2 — Apollo enrichment → decision-maker emails","PR","PREP","Filter exhibitors to ICP buyers; pull buyer/engineering contacts via Apollo People Search UI (no API key needed).","Prep sheet + filters ready — run the Apollo search per show and paste into the Prospects tab.","high","Todo",None,"sheet ready — populate",None,None,0],
...
"140":["Finalize Labs Facility Testing list (+Meta/Google/MS)","PR","PREP","Finalize a ~1,100-contact list of tech/hardware firms needing test labs.","Send Eric the vetted list (with Meta/Google/MS added) for outreach.","high","Todo",None,"sheet ready — populate",None,None,0],
...
"143":["Build June–July US trade-show list (exhibitors)","PR","PREP","Pick the single biggest US show per vertical in Jun/Jul.","Source exhibitor lists for metal-parts buyer outreach.","high","Todo",None,"sheet ready — curate",None,None,0],
